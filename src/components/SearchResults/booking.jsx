...
export default function Booking() {
    ...
    const checkCarAvailability = async () => {
        try {
            const response = await fetch(`http://localhost:3002/check-car-availability/${carID}`);
        ...
        <div style={styles.container}>
            <div style={styles.form}>
                ...
                <div className='driving_detail' style={styles.driving_detail}>
                    ...
                    {availabilityPopup && (
                        <div className="confirmation_popup" style={styles.confirmation_popup}>
                            <p>Sorry, this car is not available.</p>
                            <button onClick={() => setAvailabilityPopup(false)} style={{ width: "70px", marginTop: "15px" }}>OK</button>
                        </div>
                    )}
                    {showConfirmation && (
                        <div className="confirmation_popup" style={styles.confirmation_popup}>
